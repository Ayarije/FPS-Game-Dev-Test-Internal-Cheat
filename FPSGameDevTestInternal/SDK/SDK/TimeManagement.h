...
public:
	...
	FFrameTime TransformTime(FFrameTime& SourceTime, FFrameRate& SourceRate, FFrameRate& DestinationRate) // [0x2224150] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameNumber Subtract_FrameNumberInteger(FFrameNumber A, int32_t B) // [0x2224090] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameNumber Subtract_FrameNumberFrameNumber(FFrameNumber A, FFrameNumber B) // [0x2223fd0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameTime SnapFrameTimeToRate(FFrameTime& SourceTime, FFrameRate& SourceRate, FFrameRate& SnapToRate) // [0x2223e80] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
		typedef FFrameTime (*FuncPtr)(FFrameTime&, FFrameRate&, FFrameRate&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FFrameTime Multiply_SecondsFrameRate(float TimeInSeconds, FFrameRate& FrameRate) // [0x2223da0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameNumber Multiply_FrameNumberInteger(FFrameNumber A, int32_t B) // [0x2223ce0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FFrameNumber (*FuncPtr)(FFrameNumber, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsValid_MultipleOf(FFrameRate& InFrameRate, FFrameRate& OtherFramerate) // [0x2223be0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	bool IsValid_Framerate(FFrameRate& InFrameRate) // [0x2223b40] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameRate GetTimecodeFrameRate() // [0x2223b00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	FTimecode GetTimecode() // [0x2223ac0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameNumber Divide_FrameNumberInteger(FFrameNumber A, int32_t B) // [0x2223a00] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FFrameNumber (*FuncPtr)(FFrameNumber, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FString Conv_TimecodeToString(FTimecode& InTimecode, bool bForceSignDisplay) // [0x22238d0] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	float Conv_QualifiedFrameTimeToSeconds(FQualifiedFrameTime& InFrameTime) // [0x2223820] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	float Conv_FrameRateToSeconds(FFrameRate& InFrameRate) // [0x2223780] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
	...
	int32_t Conv_FrameNumberToInteger(FFrameNumber& InFrameNumber) // [0x22236f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
	...
	FFrameNumber Add_FrameNumberInteger(FFrameNumber A, int32_t B) // [0x2223630] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FFrameNumber (*FuncPtr)(FFrameNumber, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FFrameNumber Add_FrameNumberFrameNumber(FFrameNumber A, FFrameNumber B) // [0x2223570] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FFrameNumber (*FuncPtr)(FFrameNumber, FFrameNumber);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
