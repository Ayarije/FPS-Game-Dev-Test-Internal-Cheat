...
public:
	...
	void SetSkipAssigningGamepadToPlayer1(bool bSkipFirstPlayer) // [0x1a3d1a0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(bSkipFirstPlayer);
	}
	// Function /Script/EngineSettings.GameMapsSettings.GetSkipAssigningGamepadToPlayer1
	bool GetSkipAssigningGamepadToPlayer1() // [0x1a3d170] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	UGameMapsSettings* GetGameMapsSettings() // [0x1a3d140] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef class UGameMapsSettings* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
