...
public:
	...
	// void GetInstancedActors(TArray<AActor*>& Actors);                                                                        // [0x9f7130] Final|Native|Protected|HasOutParms|BlueprintCallable 
};
...
public:
	...
	void RegisterActorWithSkeletonBP(AActor* InActor, USkeleton* SharingSkeleton) // [0x9f73a0] Final|Native|Public|BlueprintCallable 
	{
	...
	UAnimationSharingManager* GetAnimationSharingManager(UObject* WorldContextObject) // [0x9f7070] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	bool CreateAnimationSharingManager(UObject* WorldContextObject, UAnimationSharingSetup* Setup) // [0x9f6fa0] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	bool AnimationSharingEnabled() // [0x9f6f70] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
...
public:
	...
	void ProcessActorState(int32_t& OutState, AActor* InActor, char CurrentState, char OnDemandState, bool& bShouldProcess) // [0x9f71e0] Native|Event|Public|HasOutParms|BlueprintEvent 
	{
	...
	UEnum* GetAnimationStateEnum() // [0x9f7100] Native|Event|Public|BlueprintEvent 
	{
