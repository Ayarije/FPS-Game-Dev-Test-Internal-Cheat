...
public:
	...
	SDK_UNDEFINED(16,573) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,574) /* TScriptInterface<Class> */ __um(AngleSource);                                         // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,575) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,576) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,577) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,578) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,579) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,580) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
...
public:
	...
	void UpdateWorldLocalState(bool bWorldIn) // [0x30c9420] Final|Native|Public  
	{
	...
	void UpdateHoverState(bool bHoveringIn) // [0x30c9390] Final|Native|Public  
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void SetTransform(FTransform& NewTransform) // [0x30c9220] Native|Public|HasOutParms|HasDefaults 
	{
	...
	FTransform GetTransform() // [0x30c9060] Native|Public|HasDefaults|Const 
	{
...
public:
	...
	bool HasTangentVectors() // [0x30c90d0] Native|Public|Const  
	{
	...
	void GetTangentVectors(FVector& TangentXOut, FVector& TangentYOut) // [0x30c8f70] Native|Public|HasOutParms|HasDefaults|Const 
	{
	...
	FVector GetOrigin() // [0x30c8ec0] Native|Public|HasDefaults|Const 
	{
	...
	FVector GetDirection() // [0x30c8e80] Native|Public|HasDefaults|Const 
	{
		typedef FVector (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void UpdateHoverState(bool bHovering) // [0x30c9300] Native|Public|Const  
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
...
public:
	...
	void EndUpdate() // [0x30c8e20] Native|Public        
	{
	...
	void BeginUpdate() // [0x30c8e40] Native|Public        
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
...
public:
	...
	void SetParameter(float NewValue) // [0x30c9100] Native|Public        
	{
	...
	float GetParameter() // [0x30c8f00] Native|Public|Const  
	{
	...
	void EndModify() // [0x30c8e60] Native|Public        
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void BeginModify() // [0x30c8e20] Native|Public        
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
...
public:
	...
	void SetParameter(FVector2D& NewValue) // [0x30c9190] Native|Public|HasOutParms|HasDefaults 
	{
	...
	FVector2D GetParameter() // [0x30c8f30] Native|Public|HasDefaults|Const 
	{
...
{ 
public:
	SDK_UNDEFINED(16,581) /* TScriptInterface<Class> */ __um(FloatParameterSource);                                // 0x0048   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,582) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,583) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,584) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,585) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,586) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,587) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,588) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,589) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,590) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,591) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x0058   (0x0010)  
	float                                              ScaleMultiplier;                                            // 0x0068   (0x0004)  
...
public:
	unsigned char                                      UnknownData00_8[0x48];                                      // 0x0048   (0x0048)  MISSED
	SDK_UNDEFINED(16,592) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0090   (0x0010)  
	SDK_UNDEFINED(16,593) /* TScriptInterface<Class> */ __um(TransformSource);                                     // 0x00A0   (0x0010)  
...
public:
	unsigned char                                      UnknownData00_8[0x10];                                      // 0x0038   (0x0010)  MISSED
	SDK_UNDEFINED(16,594) /* TScriptInterface<Class> */ __um(AxisSource);                                          // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,595) /* TScriptInterface<Class> */ __um(ParameterSource);                                     // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,596) /* TScriptInterface<Class> */ __um(HitTarget);                                           // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,597) /* TScriptInterface<Class> */ __um(StateTarget);                                         // 0x0078   (0x0010)  
	bool                                               bEnableSignedAxis;                                          // 0x0088   (0x0001)  
...
public:
	...
	SDK_UNDEFINED(16,598) /* TScriptInterface<Class> */ __um(TransactionManager);                                  // 0x0050   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,599) /* TScriptInterface<Class> */ __um(ChildTransformSource);                                // 0x0048   (0x0010)  
