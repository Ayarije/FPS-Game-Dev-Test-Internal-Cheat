...
public:
	...
	UMatineeCameraShake* StartMatineeCameraShakeFromSource(APlayerCameraManager* PlayerCameraManager, UClass* ShakeClass, UCameraShakeSourceComponent* SourceComponent, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot) // [0x9d2ee0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
	...
	UMatineeCameraShake* StartMatineeCameraShake(APlayerCameraManager* PlayerCameraManager, UClass* ShakeClass, float Scale, ECameraShakePlaySpace PlaySpace, FRotator UserPlaySpaceRot) // [0x9d2d10] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
	...
	void ReceiveStopShake(bool bImmediately) // [0x12295a0] Event|Public|BlueprintEvent 
	{
	...
	void ReceivePlayShake(float Scale) // [0x12295a0] Event|Public|BlueprintEvent 
	{
	...
	bool ReceiveIsFinished() // [0x9d2ce0] Native|Event|Public|BlueprintEvent|Const 
	{
	...
	void BlueprintUpdateCameraShake(float DeltaTime, float Alpha, FMinimalViewInfo& POV, FMinimalViewInfo& ModifiedPOV) // [0x12295a0] Event|Public|HasOutParms|BlueprintEvent 
	{
...
public:
	...
	UMatineeCameraShake* Conv_MatineeCameraShake(UCameraShakeBase* CameraShake) // [0x9d2c60] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
