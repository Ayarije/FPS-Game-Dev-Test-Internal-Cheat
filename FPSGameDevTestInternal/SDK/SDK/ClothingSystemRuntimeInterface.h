...
public:
	...
	void SetNumSubsteps(int32_t NumSubsteps) // [0x260dc40] Native|Public|BlueprintCallable 
	{
	...
	void SetNumIterations(int32_t NumIterations) // [0x260dbb0] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetAnimDriveSpringStiffness(float InStiffness) // [0x260db20] Native|Public|BlueprintCallable 
	{
	...
	void PhysicsAssetUpdated() // [0x1f8a930] Native|Public|BlueprintCallable 
	{
	...
	float GetSimulationTime() // [0x260db00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	int32_t GetNumSubsteps() // [0x260dae0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	int32_t GetNumKinematicParticles() // [0x260dac0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetNumIterations() // [0x260daa0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetNumDynamicParticles() // [0x260da80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetNumCloths() // [0x260da60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UClothingInteractor* GetClothingInteractor(FString ClothingAssetName) // [0x260d9b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void EnableGravityOverride(FVector& InVector) // [0x260d920] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void DisableGravityOverride() // [0x1f8a750] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void ClothConfigUpdated() // [0xd12b10] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
