...
public:
	...
	USplineComponent* GetRailSplineComponent() // [0x24ebdc0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
...
public:
	...
	UCineCameraComponent* GetCineCameraComponent() // [0x24eb9f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	void SetLensPresetByName(FString InPresetName) // [0x24ebf30] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetFilmbackPresetByName(FString InPresetName) // [0x24ebe90] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FString);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetCurrentFocalLength(float InFocalLength) // [0x24ebe10] Final|Native|Public|BlueprintCallable 
	{
	...
	float GetVerticalFieldOfView() // [0x24ebde0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// TArray<FNamedLensPreset> GetLensPresetsCopy();                                                                           // [0x24ebce0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetLensPresetName
	FString GetLensPresetName() // [0x24ebc60] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetHorizontalFieldOfView() // [0x24ebc30] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	// TArray<FNamedFilmbackPreset> GetFilmbackPresetsCopy();                                                                   // [0x24ebb50] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/CinematicCamera.CineCameraComponent.GetFilmbackPresetName
	FString GetFilmbackPresetName() // [0x24ebad0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FString (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FString GetDefaultFilmbackPresetName() // [0x24eba10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FString (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
