...
{ 
public:
	SDK_UNDEFINED(16,359) /* FMulticastInlineDelegate */ __um(OnInstanceTakePointDamage);                          // 0x0678   (0x0010)  
	SDK_UNDEFINED(16,360) /* FMulticastInlineDelegate */ __um(OnInstanceTakeRadialDamage);                         // 0x0688   (0x0010)  
...
public:
	...
	int32_t FoliageOverlappingSphereCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FVector CenterPosition, float Radius) // [0x21e5840] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
		typedef int32_t (*FuncPtr)(UObject*, UStaticMesh*, FVector, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(WorldContextObject, StaticMesh, CenterPosition, Radius);
	}
	// Function /Script/Foliage.FoliageStatistics.FoliageOverlappingBoxCount
	int32_t FoliageOverlappingBoxCount(UObject* WorldContextObject, UStaticMesh* StaticMesh, FBox Box) // [0x21e5700] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	{
		typedef int32_t (*FuncPtr)(UObject*, UStaticMesh*, FBox);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(WorldContextObject, StaticMesh, Box);
	}
};
...
public:
	...
	void CapsuleTouched(UPrimitiveComponent* OverlappedComp, AActor* Other, UPrimitiveComponent* OtherComp, int32_t OtherBodyIndex, bool bFromSweep, FHitResult& OverlapInfo) // [0x21e54f0] Final|Native|Protected|HasOutParms 
	{
		typedef void (*FuncPtr)(UPrimitiveComponent*, AActor*, UPrimitiveComponent*, int32_t, bool, FHitResult&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(OverlappedComp, Other, OtherComp, OtherBodyIndex, bFromSweep, OverlapInfo);
	}
};
...
public:
	...
	void Simulate(int32_t NumSteps) // [0x21e59a0] Final|Native|Public|BlueprintCallable 
	{
