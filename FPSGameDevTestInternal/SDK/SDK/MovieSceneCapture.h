...
public:
	...
	bool IsCapturing() // [0x26550b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	EMovieSceneCaptureProtocolState GetState() // [0x1fb5130] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef EMovieSceneCaptureProtocolState (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void SetImageCaptureProtocolType(UClass* ProtocolType) // [0x2655330] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetAudioCaptureProtocolType(UClass* ProtocolType) // [0x26552a0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	UMovieSceneCaptureProtocolBase* GetImageCaptureProtocol() // [0x2655060] Final|Native|Public|BlueprintCallable 
	{
		typedef class UMovieSceneCaptureProtocolBase* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func();
	}
	// Function /Script/MovieSceneCapture.MovieSceneCapture.GetAudioCaptureProtocol
	UMovieSceneCaptureProtocolBase* GetAudioCaptureProtocol() // [0x2654fc0] Final|Native|Public|BlueprintCallable 
	{
		typedef class UMovieSceneCaptureProtocolBase* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	bool IsCaptureInProgress() // [0x2655080] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	int32_t GetCaptureFrameNumber() // [0x2655010] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	float GetCaptureElapsedTime() // [0x2654fe0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UMovieSceneImageCaptureProtocolBase* FindImageCaptureProtocol() // [0x2654c80] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UMovieSceneImageCaptureProtocolBase* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func();
	}
	// Function /Script/MovieSceneCapture.MovieSceneCaptureEnvironment.FindAudioCaptureProtocol
	UMovieSceneAudioCaptureProtocolBase* FindAudioCaptureProtocol() // [0x2654c50] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UMovieSceneAudioCaptureProtocolBase* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void StopCapturingFinalPixels() // [0x26554c0] Final|Native|Public|BlueprintCallable 
	{
	...
	void StartCapturingFinalPixels(FCapturedPixelsID& StreamID) // [0x26553c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FCapturedPixelsID&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		func(StreamID);
	}
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.ResolveBuffer
	void ResolveBuffer(UTexture* Buffer, FCapturedPixelsID& BufferID) // [0x2655150] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UTexture*, FCapturedPixelsID&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		func(Buffer, BufferID);
	}
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnWarmUp
	void OnWarmUp() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void OnTick() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void OnStartCapture() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool OnSetup() // [0x2655120] Native|Event|Protected|BlueprintEvent 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnPreTick() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnPixelsReceived(FCapturedPixels& Pixels, FCapturedPixelsID& ID, FFrameMetrics FrameMetrics) // [0x12295a0] Event|Protected|HasOutParms|BlueprintEvent 
	{
		typedef void (*FuncPtr)(FCapturedPixels&, FCapturedPixelsID&, FFrameMetrics);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
		func(Pixels, ID, FrameMetrics);
	}
	// Function /Script/MovieSceneCapture.UserDefinedCaptureProtocol.OnPauseCapture
	void OnPauseCapture() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnFinalize() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnCaptureFrame() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool OnCanFinalize() // [0x26550f0] Native|Event|Protected|BlueprintEvent|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnBeginFinalize() // [0x12295a0] Event|Protected|BlueprintEvent 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FFrameMetrics GetCurrentFrameMetrics() // [0x2655040] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FFrameMetrics (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FString GenerateFilename(FFrameMetrics& InFrameMetrics) // [0x2654cb0] Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FString (*FuncPtr)(FFrameMetrics&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[15]);
		return func(InFrameMetrics);
	}
};
...
public:
	...
	void WriteImageToDisk(FCapturedPixels& PixelData, FCapturedPixelsID& StreamID, FFrameMetrics& FrameMetrics, bool bCopyImageData) // [0x26554e0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FCapturedPixels&, FCapturedPixelsID&, FFrameMetrics&, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(PixelData, StreamID, FrameMetrics, bCopyImageData);
	}
	// Function /Script/MovieSceneCapture.UserDefinedImageCaptureProtocol.GenerateFilenameForCurrentFrame
	FString GenerateFilenameForCurrentFrame() // [0x2654f40] Final|Native|Public|BlueprintCallable 
	{
	...
	FString GenerateFilenameForBuffer(UTexture* Buffer, FCapturedPixelsID& StreamID) // [0x2654da0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef FString (*FuncPtr)(UTexture*, FCapturedPixelsID&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(Buffer, StreamID);
	}
};
