...
public:
	...
	void SetVelocityScale(FVector LinearVelocityScale, float AngularVelocityScale, float FictitiousAngularScale) // [0xa6e580] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FVector, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(LinearVelocityScale, AngularVelocityScale, FictitiousAngularScale);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetMaterialLinear
	void SetMaterialLinear(float EdgeStiffness, float BendingStiffness, float AreaStiffness) // [0xa6e460] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		func(EdgeStiffness, BendingStiffness, AreaStiffness);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetLongRangeAttachmentLinear
	void SetLongRangeAttachmentLinear(float TetherStiffness) // [0xa6e3e0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		func(TetherStiffness);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetLongRangeAttachment
	void SetLongRangeAttachment(FVector2D TetherStiffness) // [0xa6e360] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetGravity(float GravityScale, bool bIsGravityOverridden, FVector GravityOverride) // [0xa6e230] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, bool, FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		func(GravityScale, bIsGravityOverridden, GravityOverride);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetDamping
	void SetDamping(float DampingCoefficient) // [0xa6e1b0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetCollision(float CollisionThickness, float FrictionCoefficient, bool bUseCCD, float SelfCollisionThickness) // [0xa6e040] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, float, bool, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
		func(CollisionThickness, FrictionCoefficient, bUseCCD, SelfCollisionThickness);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAnimDriveLinear
	void SetAnimDriveLinear(float AnimDriveStiffness) // [0xa6dfc0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		func(AnimDriveStiffness);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAnimDrive
	void SetAnimDrive(FVector2D AnimDriveStiffness, FVector2D AnimDriveDamping) // [0xa6df00] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FVector2D, FVector2D);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
		func(AnimDriveStiffness, AnimDriveDamping);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.SetAerodynamics
	void SetAerodynamics(float DragCoefficient, float LiftCoefficient, FVector WindVelocity) // [0xa6dde0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, float, FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
		func(DragCoefficient, LiftCoefficient, WindVelocity);
	}
	// Function /Script/ChaosCloth.ChaosClothingInteractor.ResetAndTeleport
	void ResetAndTeleport(bool bReset, bool bTeleport) // [0xa6dd10] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[10]);
		func(bReset, bTeleport);
	}
};
