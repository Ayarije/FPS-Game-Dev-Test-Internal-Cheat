...
public:
	...
	bool GetEyeBlinkState(FMagicLeapEyeBlinkState& BlinkState) // [0xd60790] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(FMagicLeapEyeBlinkState&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(BlinkState);
	}
	// Function /Script/MagicLeapEyeTracker.MagicLeapEyeTrackerFunctionLibrary.GetCalibrationStatus
	EMagicLeapEyeTrackingCalibrationStatus GetCalibrationStatus() // [0xd60760] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef EMagicLeapEyeTrackingCalibrationStatus (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
