...
public:
	...
	bool IsValidKeyFrameIndex(int32_t Index) // [0x9cae40] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetTotalDuration() // [0x9cad80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	UPaperSprite* GetSpriteAtTime(float Time, bool bClampToEnds) // [0x9ca4e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef class UPaperSprite* (*FuncPtr)(float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(Time, bClampToEnds);
	}
	// Function /Script/Paper2D.PaperFlipbook.GetSpriteAtFrame
	UPaperSprite* GetSpriteAtFrame(int32_t FrameIndex) // [0x9ca440] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef class UPaperSprite* (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(FrameIndex);
	}
	// Function /Script/Paper2D.PaperFlipbook.GetNumKeyFrames
	int32_t GetNumKeyFrames() // [0x9ca390] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	int32_t GetNumFrames() // [0x9ca360] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetKeyFrameIndexAtTime(float Time, bool bClampToEnds) // [0x9ca0b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)(float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	SDK_UNDEFINED(16,639) /* FMulticastInlineDelegate */ __um(OnFinishedPlaying);                                  // 0x04B0   (0x0010)  


	/// Functions
	// Function /Script/Paper2D.PaperFlipbookComponent.Stop
	void Stop() // [0x9cc160] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetSpriteColor(FLinearColor NewColor) // [0x9cbd10] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
	...
	void SetPlayRate(float NewRate) // [0x9cbae0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetPlaybackPositionInFrames(int32_t NewFramePosition, bool bFireEvents) // [0x9cbc40] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		func(NewFramePosition, bFireEvents);
	}
	// Function /Script/Paper2D.PaperFlipbookComponent.SetPlaybackPosition
	void SetPlaybackPosition(float NewPosition, bool bFireEvents) // [0x9cbb60] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		func(NewPosition, bFireEvents);
	}
	// Function /Script/Paper2D.PaperFlipbookComponent.SetNewTime
	void SetNewTime(float NewTime) // [0x9cba60] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
	...
	void SetLooping(bool bNewLooping) // [0x9cb9d0] Final|Native|Public|BlueprintCallable 
	{
	...
	bool SetFlipbook(UPaperFlipbook* NewFlipbook) // [0x9cb620] Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UPaperFlipbook*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		return func(NewFlipbook);
	}
	// Function /Script/Paper2D.PaperFlipbookComponent.ReverseFromEnd
	void ReverseFromEnd() // [0x9cb520] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void Reverse() // [0x9cb500] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void PlayFromStart() // [0x9cb350] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void Play() // [0x9cb330] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void OnRep_SourceFlipbook(UPaperFlipbook* OldFlipbook) // [0x9cb270] Final|Native|Protected 
	{
		typedef void (*FuncPtr)(UPaperFlipbook*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[12]);
		func(OldFlipbook);
	}
	// Function /Script/Paper2D.PaperFlipbookComponent.IsReversing
	bool IsReversing() // [0x9cae10] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	bool IsPlaying() // [0x9cade0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsLooping() // [0x9cadb0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FLinearColor GetSpriteColor() // [0x9ca5c0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetPlayRate() // [0x9ca3b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetPlaybackPositionInFrames() // [0x9ca410] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetPlaybackPosition() // [0x9ca3e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetFlipbookLengthInFrames() // [0x9c9ef0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetFlipbookLength() // [0x9c9ec0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetFlipbookFramerate() // [0x9c9e90] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UPaperFlipbook* GetFlipbook() // [0x9c9e60] Native|Public|BlueprintCallable|BlueprintPure 
	{
		typedef class UPaperFlipbook* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
/// Size: 0x04B0 (1200 bytes) (0x000478 - 0x0004B0) align 16 MaxSize: 0x04B0
...
public:
	...
	bool UpdateInstanceTransform(int32_t InstanceIndex, FTransform& NewInstanceTransform, bool bWorldSpace, bool bMarkRenderStateDirty, bool bTeleport) // [0x9cc2a0] Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(int32_t, FTransform&, bool, bool, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(InstanceIndex, NewInstanceTransform, bWorldSpace, bMarkRenderStateDirty, bTeleport);
	}
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.UpdateInstanceColor
	bool UpdateInstanceColor(int32_t InstanceIndex, FLinearColor NewInstanceColor, bool bMarkRenderStateDirty) // [0x9cc180] Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(int32_t, FLinearColor, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(InstanceIndex, NewInstanceColor, bMarkRenderStateDirty);
	}
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.SortInstancesAlongAxis
	void SortInstancesAlongAxis(FVector WorldSpaceSortAxis) // [0x9cc0d0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		func(WorldSpaceSortAxis);
	}
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.RemoveInstance
	bool RemoveInstance(int32_t InstanceIndex) // [0x9cb390] Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(InstanceIndex);
	}
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceTransform
	bool GetInstanceTransform(int32_t InstanceIndex, FTransform& OutInstanceTransform, bool bWorldSpace) // [0x9c9f50] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)(int32_t, FTransform&, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		return func(InstanceIndex, OutInstanceTransform, bWorldSpace);
	}
	// Function /Script/Paper2D.PaperGroupedSpriteComponent.GetInstanceCount
	int32_t GetInstanceCount() // [0x9c9f20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
	...
	void ClearInstances() // [0x9c9c70] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
	...
	int32_t AddInstance(FTransform& Transform, UPaperSprite* Sprite, bool bWorldSpace, FLinearColor Color) // [0x9c9840] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef int32_t (*FuncPtr)(FTransform&, UPaperSprite*, bool, FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		return func(Transform, Sprite, bWorldSpace, Color);
	}
};
...
public:
	...
	FSlateBrush MakeBrushFromSprite(UPaperSprite* Sprite, int32_t Width, int32_t Height) // [0x9caee0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef FSlateBrush (*FuncPtr)(UPaperSprite*, int32_t, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(Sprite, Width, Height);
	}
};

/// Class /Script/Paper2D.PaperSpriteComponent
/// Size: 0x04A0 (1184 bytes) (0x000478 - 0x0004A0) align 16 MaxSize: 0x04A0
...
public:
	...
	void SetSpriteColor(FLinearColor NewColor) // [0x9cbda0] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	bool SetSprite(UPaperSprite* NewSprite) // [0x9cb620] Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UPaperSprite*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(NewSprite);
	}
	// Function /Script/Paper2D.PaperSpriteComponent.GetSprite
	UPaperSprite* GetSprite() // [0x9c9e60] Native|Public|BlueprintCallable|BlueprintPure 
	{
		typedef class UPaperSprite* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func();
	}
...
public:
	...
	void SetTerrainColor(FLinearColor NewColor) // [0x9cbe30] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
...
/// Size: 0x04D0 (1232 bytes) (0x000478 - 0x0004D0) align 16 MaxSize: 0x04D0
...
public:
	...
	void SetTileMapColor(FLinearColor NewColor) // [0x9cc040] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	bool SetTileMap(UPaperTileMap* NewTileMap) // [0x9cb620] Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UPaperTileMap*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(NewTileMap);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.SetTile
	void SetTile(int32_t X, int32_t Y, int32_t Layer, FPaperTileInfo NewValue) // [0x9cbec0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t, int32_t, int32_t, FPaperTileInfo);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		func(X, Y, Layer, NewValue);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerColor
	void SetLayerColor(FLinearColor NewColor, int32_t Layer) // [0x9cb900] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FLinearColor, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		func(NewColor, Layer);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.SetLayerCollision
	void SetLayerCollision(int32_t Layer, bool bHasCollision, bool bOverrideThickness, float CustomThickness, bool bOverrideOffset, float CustomOffset, bool bRebuildCollision) // [0x9cb6c0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t, bool, bool, float, bool, float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		func(Layer, bHasCollision, bOverrideThickness, CustomThickness, bOverrideOffset, CustomOffset, bRebuildCollision);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.SetDefaultCollisionThickness
	void SetDefaultCollisionThickness(float Thickness, bool bRebuildCollision) // [0x9cb540] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
		func(Thickness, bRebuildCollision);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.ResizeMap
	void ResizeMap(int32_t NewWidthInTiles, int32_t NewHeightInTiles) // [0x9cb430] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
		func(NewWidthInTiles, NewHeightInTiles);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.RebuildCollision
	void RebuildCollision() // [0x9cb370] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
	...
	bool OwnsTileMap() // [0x9cb300] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
	...
	void MakeTileMapEditable() // [0x9cb250] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
	...
	// void GetTilePolygon(int32_t TileX, int32_t TileY, TArray<FVector>& Points, int32_t LayerIndex, bool bWorldSpace);        // [0x9caa30] Final|Native|Public|HasOutParms|BlueprintCallable|BlueprintPure|Const 
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileMapColor
	FLinearColor GetTileMapColor() // [0x9ca9f0] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FLinearColor (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[11]);
	...
	FVector GetTileCornerPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace) // [0x9ca880] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FVector (*FuncPtr)(int32_t, int32_t, int32_t, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[12]);
		return func(TileX, TileY, LayerIndex, bWorldSpace);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.GetTileCenterPosition
	FVector GetTileCenterPosition(int32_t TileX, int32_t TileY, int32_t LayerIndex, bool bWorldSpace) // [0x9ca710] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FVector (*FuncPtr)(int32_t, int32_t, int32_t, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[13]);
	...
	FPaperTileInfo GetTile(int32_t X, int32_t Y, int32_t Layer) // [0x9ca5f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FPaperTileInfo (*FuncPtr)(int32_t, int32_t, int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[14]);
		return func(X, Y, Layer);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.GetMapSize
	void GetMapSize(int32_t& MapWidth, int32_t& MapHeight, int32_t& NumLayers) // [0x9ca220] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t&, int32_t&, int32_t&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[15]);
		func(MapWidth, MapHeight, NumLayers);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.GetLayerColor
	FLinearColor GetLayerColor(int32_t Layer) // [0x9ca180] Final|Native|Public|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FLinearColor (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[16]);
		return func(Layer);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.CreateNewTileMap
	void CreateNewTileMap(int32_t MapWidth, int32_t MapHeight, int32_t TileWidth, int32_t TileHeight, float PixelsPerUnrealUnit, bool bCreateLayer) // [0x9c9c90] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t, int32_t, int32_t, int32_t, float, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[17]);
		func(MapWidth, MapHeight, TileWidth, TileHeight, PixelsPerUnrealUnit, bCreateLayer);
	}
	// Function /Script/Paper2D.PaperTileMapComponent.AddNewLayer
	UPaperTileLayer* AddNewLayer() // [0x9c9a10] Final|Native|Public|BlueprintCallable 
	{
		typedef class UPaperTileLayer* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[18]);
		return func();
	}
...
public:
	...
	FPaperTileInfo MakeTile(int32_t TileIndex, UPaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD) // [0x9cb080] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef FPaperTileInfo (*FuncPtr)(int32_t, UPaperTileSet*, bool, bool, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(TileIndex, TileSet, bFlipH, bFlipV, bFlipD);
	}
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileUserData
	FName GetTileUserData(FPaperTileInfo Tile) // [0x9cace0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef FName (*FuncPtr)(FPaperTileInfo);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(Tile);
	}
	// Function /Script/Paper2D.TileMapBlueprintLibrary.GetTileTransform
	FTransform GetTileTransform(FPaperTileInfo Tile) // [0x9cac00] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FTransform (*FuncPtr)(FPaperTileInfo);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(Tile);
	}
	// Function /Script/Paper2D.TileMapBlueprintLibrary.BreakTile
	void BreakTile(FPaperTileInfo Tile, int32_t& TileIndex, UPaperTileSet*& TileSet, bool& bFlipH, bool& bFlipV, bool& bFlipD) // [0x9c9a40] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
		typedef void (*FuncPtr)(FPaperTileInfo, int32_t&, UPaperTileSet*&, bool&, bool&, bool&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		func(Tile, TileIndex, TileSet, bFlipH, bFlipV, bFlipD);
	}
};
