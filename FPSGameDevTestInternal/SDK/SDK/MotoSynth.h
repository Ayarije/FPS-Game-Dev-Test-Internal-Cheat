...
public:
	...
	void SetSettings(FMotoSynthRuntimeSettings& InSettings) // [0xd37360] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FMotoSynthRuntimeSettings&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(InSettings);
	}
	// Function /Script/MotoSynth.SynthComponentMoto.SetRPM
	void SetRPM(float InRPM, float InTimeSec) // [0xd37290] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		func(InRPM, InTimeSec);
	}
	// Function /Script/MotoSynth.SynthComponentMoto.IsEnabled
	bool IsEnabled() // [0xd37260] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void GetRPMRange(float& OutMinRPM, float& OutMaxRPM) // [0xd37180] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float&, float&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		func(OutMinRPM, OutMaxRPM);
	}
};
