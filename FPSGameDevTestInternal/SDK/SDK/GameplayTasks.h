...
public:
	...
	void ReadyForActivation() // [0x2fd95b0] Final|Native|Public|BlueprintCallable 
	{
	...
	void GenericGameplayTaskDelegate__DelegateSignature() // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void EndTask() // [0x2fd9250] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	// UGameplayTask_ClaimResource* ClaimResources(TScriptInterface<Class> InTaskOwner, TArray<UClass*> ResourceClasses, char Priority, FName TaskInstanceName); // [0x2fd9090] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_ClaimResource.ClaimResource
	// UGameplayTask_ClaimResource* ClaimResource(TScriptInterface<Class> InTaskOwner, UClass* ResourceClass, char Priority, FName TaskInstanceName); // [0x2fd8f20] Final|Native|Static|Public|BlueprintCallable 
};
...
{ 
public:
	SDK_UNDEFINED(16,256) /* FMulticastInlineDelegate */ __um(Success);                                            // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,257) /* FMulticastInlineDelegate */ __um(DidNotSpawn);                                        // 0x0078   (0x0010)  
	...
	// UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<Class> TaskOwner, FVector SpawnLocation, FRotator SpawnRotation, UClass* Class, bool bSpawnOnlyOnAuthority); // [0x2fd95d0] Final|Native|Static|Public|HasDefaults|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_SpawnActor.FinishSpawningActor
	void FinishSpawningActor(UObject* WorldContextObject, AActor* SpawnedActor) // [0x2fd9270] Native|Public|BlueprintCallable 
	{
	...
	bool BeginSpawningActor(UObject* WorldContextObject, AActor*& SpawnedActor) // [0x2fd8e40] Native|Public|HasOutParms|BlueprintCallable 
	{
...
{ 
public:
	SDK_UNDEFINED(16,258) /* FMulticastInlineDelegate */ __um(OnFinished);                                         // 0x0068   (0x0010)  
	SDK_UNDEFINED(16,259) /* FMulticastInlineDelegate */ __um(OnTimeExpired);                                      // 0x0078   (0x0010)  
...
{ 
public:
	SDK_UNDEFINED(16,260) /* FMulticastInlineDelegate */ __um(OnFinish);                                           // 0x0068   (0x0010)  
	unsigned char                                      UnknownData00_7[0x8];                                       // 0x0078   (0x0008)  MISSED


	/// Functions
	// Function /Script/GameplayTasks.GameplayTask_WaitDelay.TaskWaitDelay
	// UGameplayTask_WaitDelay* TaskWaitDelay(TScriptInterface<Class> TaskOwner, float Time, char Priority);                    // [0x2fd97a0] Final|Native|Static|Public|BlueprintCallable 
	// Function /Script/GameplayTasks.GameplayTask_WaitDelay.TaskDelayDelegate__DelegateSignature
	void TaskDelayDelegate__DelegateSignature() // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
...
public:
	...
	SDK_UNDEFINED(16,261) /* FMulticastInlineDelegate */ __um(OnClaimedResourcesChange);                           // 0x0110   (0x0010)  


	/// Functions
	// Function /Script/GameplayTasks.GameplayTasksComponent.OnRep_SimulatedTasks
	void OnRep_SimulatedTasks() // [0x2fd9590] Final|Native|Public  
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	// EGameplayTaskRunResult K2_RunGameplayTask(TScriptInterface<Class> TaskOwner, UGameplayTask* Task, char Priority, TArray<UClass*> AdditionalRequiredResources, TArray<UClass*> AdditionalClaimedResources); // [0x2fd9340] Final|Native|Static|Public|BlueprintCallable 
};
