...
public:
	...
	void OnMatchReceivedTurn(FString Match, bool bDidBecomeActive) // [0x12295a0] Event|Public|BlueprintEvent 
	{
		typedef void (*FuncPtr)(FString, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(Match, bDidBecomeActive);
	}
	// Function /Script/OnlineSubsystem.TurnBasedMatchInterface.OnMatchEnded
	void OnMatchEnded(FString Match) // [0x12295a0] Event|Public|BlueprintEvent 
	{
