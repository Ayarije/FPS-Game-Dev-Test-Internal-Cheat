...
public:
	...
	UVariantSet* GetVariantSetByName(FString VariantSetName) // [0xa14900] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UVariantSet* GetVariantSet(int32_t VariantSetIndex) // [0xa14860] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	int32_t GetNumVariantSets() // [0xa14450] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
...
public:
	...
	TMap<class UBlueprintGeneratedClass*, class ULevelVariantSetsFunctionDirector*> DirectorInstances;             // 0x0238   (0x0050)  


	/// Functions
	// Function /Script/VariantManagerContent.LevelVariantSetsActor.SwitchOnVariantByName
	bool SwitchOnVariantByName(FString VariantSetName, FString VariantName) // [0xa15640] Final|Native|Public|BlueprintCallable 
	{
	...
	bool SwitchOnVariantByIndex(int32_t VariantSetIndex, int32_t VariantIndex) // [0xa15570] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetLevelVariantSets(ULevelVariantSets* InVariantSets) // [0xa14da0] Final|Native|Public|BlueprintCallable 
	{
	...
	ULevelVariantSets* GetLevelVariantSets(bool bLoad) // [0xa14350] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	SDK_UNDEFINED(16,664) /* TArray<Properties> */     __um(Properties);                                           // 0x0088   (0x0010)  
	...
	bool HasRecordedData() // [0xa14a00] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FText GetPropertyTooltip() // [0xa14590] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	FString GetFullDisplayString() // [0xa14310] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	void SelectOption(int32_t OptionIndex) // [0xa14a60] Final|Native|Public|BlueprintCallable 
	{
	...
	int32_t GetSelectedOption() // [0xa14630] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	// TArray<AActor*> GetOptions();                                                                                            // [0xa144b0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
};
...
public:
	...
	void SwitchOn() // [0xa15550] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetThumbnailFromTexture(UTexture2D* NewThumbnail) // [0xa15430] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetThumbnailFromFile(FString FilePath) // [0xa15250] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetThumbnailFromEditorViewport() // [0xa15230] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void SetThumbnailFromCamera(UObject* WorldContextObject, FTransform& CameraTransform, float FOVDegrees, float MinZ, float Gamma) // [0xa14e30] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SetDisplayText(FText& NewDisplayText) // [0xa14c00] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetDependency(int32_t Index, FVariantDependency& Dependency) // [0xa14af0] Final|Native|Public|HasOutParms 
	{
	...
	bool IsActive() // [0xa14a30] Final|Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UTexture2D* GetThumbnail() // [0xa14660] Final|Native|Public|BlueprintCallable 
	{
	...
	UVariantSet* GetParent() // [0xa14530] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	int32_t GetNumDependencies() // [0xa14420] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t GetNumActors() // [0xa143f0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FText GetDisplayText() // [0xa141d0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FText (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	// TArray<UVariant*> GetDependents(ULevelVariantSets* LevelVariantSets, bool bOnlyEnabledDependencies);                     // [0xa140c0] Final|Native|Public|BlueprintCallable 
	// Function /Script/VariantManagerContent.Variant.GetDependency
	FVariantDependency GetDependency(int32_t Index) // [0xa14020] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	AActor* GetActor(int32_t ActorIndex) // [0xa13f80] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	void DeleteDependency(int32_t Index) // [0xa13ef0] Final|Native|Public  
	{
		typedef void (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	int32_t AddDependency(FVariantDependency& Dependency) // [0xa13e20] Final|Native|Public|HasOutParms 
	{
...
public:
	...
	void SetThumbnailFromTexture(UTexture2D* NewThumbnail) // [0xa154c0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UTexture2D*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void SetThumbnailFromFile(FString FilePath) // [0xa15340] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FString);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void SetThumbnailFromCamera(UObject* WorldContextObject, FTransform& CameraTransform, float FOVDegrees, float MinZ, float Gamma) // [0xa15030] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UObject*, FTransform&, float, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	void SetDisplayText(FText& NewDisplayText) // [0xa14cd0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FText&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	UVariant* GetVariantByName(FString VariantName) // [0xa14760] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UVariant* GetVariant(int32_t VariantIndex) // [0xa146c0] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	UTexture2D* GetThumbnail() // [0xa14690] Final|Native|Public|BlueprintCallable 
	{
		typedef class UTexture2D* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
	...
	ULevelVariantSets* GetParent() // [0xa14560] Final|Native|Public|BlueprintCallable|BlueprintPure 
	{
	...
	int32_t GetNumVariants() // [0xa14480] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef int32_t (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
	...
	FText GetDisplayText() // [0xa14270] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef FText (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[10]);
...
static_assert(offsetof(ALevelVariantSetsActor, DirectorInstances) == 0x0238);
