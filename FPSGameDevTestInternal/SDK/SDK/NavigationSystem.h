...
public:
	...
	bool IsValid() // [0x2fd0f80] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	bool IsStringPulled() // [0x2fd0f50] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsPartial() // [0x2fd0f20] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	float GetPathLength() // [0x2fd07e0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	float GetPathCost() // [0x2fd0580] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef float (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FString GetDebugString() // [0x2fd0470] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	// void EnableRecalculationOnInvalidation(TEnumAsByte<ENavigationOptionFlag> DoRecalculation);                              // [0x2fd0010] Final|Native|Public|BlueprintCallable 
	// Function /Script/NavigationSystem.NavigationPath.EnableDebugDrawing
	void EnableDebugDrawing(bool bShouldDrawDebugData, FLinearColor PathColor) // [0x2fcff30] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool, FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		func(bShouldDrawDebugData, PathColor);
	}
};
...
public:
	...
	void UnregisterNavigationInvoker(AActor* Invoker) // [0x2fd1eb0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SimpleMoveToLocation(AController* Controller, FVector& Goal) // [0x2fd1df0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
	...
	void SimpleMoveToActor(AController* Controller, AActor* Goal) // [0x2eeb850] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	void SetMaxSimultaneousTileGenerationJobsCount(int32_t MaxNumberOfJobs) // [0x2fd1d60] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		func(MaxNumberOfJobs);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.SetGeometryGatheringMode
	void SetGeometryGatheringMode(ENavDataGatheringModeConfig NewMode) // [0x2fd1ce0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(ENavDataGatheringModeConfig);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		func(NewMode);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.ResetMaxSimultaneousTileGenerationJobsCount
	void ResetMaxSimultaneousTileGenerationJobsCount() // [0x2fd1cc0] Final|Native|Public|BlueprintCallable 
	{
	...
	void RegisterNavigationInvoker(AActor* Invoker, float TileGenerationRadius, float TileRemovalRadius) // [0x2fd1bb0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(AActor*, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
		func(Invoker, TileGenerationRadius, TileRemovalRadius);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.ProjectPointToNavigation
	FVector ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent) // [0x2fd19c0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(UObject*, FVector&, ANavigationData*, UClass*, FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		return func(WorldContextObject, Point, NavData, FilterClass, QueryExtent);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.OnNavigationBoundsUpdated
	void OnNavigationBoundsUpdated(ANavMeshBoundsVolume* NavVolume) // [0x2fd1930] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(ANavMeshBoundsVolume*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
		func(NavVolume);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.NavigationRaycast
	bool NavigationRaycast(UObject* WorldContextObject, FVector& RayStart, FVector& RayEnd, FVector& HitLocation, UClass* FilterClass, AController* Querier) // [0x2fd1700] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, FVector&, UClass*, AController*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
		return func(WorldContextObject, RayStart, RayEnd, HitLocation, FilterClass, Querier);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ReplaceAreaInOctreeData
	bool K2_ReplaceAreaInOctreeData(UObject* Object, UClass* OldArea, UClass* NewArea) // [0x2fd15f0] Final|Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UObject*, UClass*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[10]);
		return func(Object, OldArea, NewArea);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_ProjectPointToNavigation
	bool K2_ProjectPointToNavigation(UObject* WorldContextObject, FVector& Point, FVector& ProjectedLocation, ANavigationData* NavData, UClass* FilterClass, FVector QueryExtent) // [0x2fd13f0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, ANavigationData*, UClass*, FVector);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[11]);
		return func(WorldContextObject, Point, ProjectedLocation, NavData, FilterClass, QueryExtent);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomReachablePointInRadius
	bool K2_GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x2fd11d0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[12]);
		return func(WorldContextObject, Origin, RandomLocation, Radius, NavData, FilterClass);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.K2_GetRandomPointInNavigableRadius
	bool K2_GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x2fd0fb0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool K2_GetRandomLocationInNavigableRadius(UObject* WorldContextObject, FVector& Origin, FVector& RandomLocation, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x2fd0fb0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UObject*, FVector&, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool IsNavigationBeingBuiltOrLocked(UObject* WorldContextObject) // [0x2fd0e90] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
	...
	bool IsNavigationBeingBuilt(UObject* WorldContextObject) // [0x2fd0e00] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef bool (*FuncPtr)(UObject*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	FVector GetRandomReachablePointInRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x2fd0c20] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(UObject*, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[17]);
		return func(WorldContextObject, Origin, Radius, NavData, FilterClass);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.GetRandomPointInNavigableRadius
	FVector GetRandomPointInNavigableRadius(UObject* WorldContextObject, FVector& Origin, float Radius, ANavigationData* NavData, UClass* FilterClass) // [0x2fd0a40] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(UObject*, FVector&, float, ANavigationData*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	// TEnumAsByte<ENavigationQueryResult> GetPathLength(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathLength, ANavigationData* NavData, UClass* FilterClass); // [0x2fd0810] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetPathCost
	// TEnumAsByte<ENavigationQueryResult> GetPathCost(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, float& PathCost, ANavigationData* NavData, UClass* FilterClass); // [0x2fd05b0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	// Function /Script/NavigationSystem.NavigationSystemV1.GetNavigationSystem
	UNavigationSystemV1* GetNavigationSystem(UObject* WorldContextObject) // [0x2fd04f0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef class UNavigationSystemV1* (*FuncPtr)(UObject*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	UNavigationPath* FindPathToLocationSynchronously(UObject* WorldContextObject, FVector& PathStart, FVector& PathEnd, AActor* PathfindingContext, UClass* FilterClass) // [0x2fd02a0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef class UNavigationPath* (*FuncPtr)(UObject*, FVector&, FVector&, AActor*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[22]);
		return func(WorldContextObject, PathStart, PathEnd, PathfindingContext, FilterClass);
	}
	// Function /Script/NavigationSystem.NavigationSystemV1.FindPathToActorSynchronously
	UNavigationPath* FindPathToActorSynchronously(UObject* WorldContextObject, FVector& PathStart, AActor* GoalActor, float TetherDistance, AActor* PathfindingContext, UClass* FilterClass) // [0x2fd0090] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef class UNavigationPath* (*FuncPtr)(UObject*, FVector&, AActor*, float, AActor*, UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[23]);
		return func(WorldContextObject, PathStart, GoalActor, TetherDistance, PathfindingContext, FilterClass);
	}
};
...
public:
	...
	void SetNavigationRelevancy(bool bRelevant) // [0x2fd3ee0] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	void SetAreaClass(UClass* NewAreaClass) // [0x2fd3e50] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	void SetAreaClass(UClass* NewAreaClass) // [0x2fd3dc0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UClass*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
...
public:
	...
	bool K2_ReplaceAreaInTileBounds(FBox Bounds, UClass* OldArea, UClass* NewArea, bool ReplaceLinks) // [0x2fd3c20] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(FBox, UClass*, UClass*, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(Bounds, OldArea, NewArea, ReplaceLinks);
	}
};
