...
{ 
	...
	SDK_UNDEFINED(80,331) /* TSet<UObject*> */         __um(ChaosHandlers);                                        // 0x0008   (0x0050)  
};
...
public:
	...
	FHitResult ConvertPhysicsCollisionToHitResult(FChaosPhysicsCollisionInfo& PhysicsCollision) // [0x307ec50] Final|Native|Static|Public|HasOutParms|BlueprintCallable|BlueprintPure 
	{
		typedef FHitResult (*FuncPtr)(FChaosPhysicsCollisionInfo&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(PhysicsCollision);
	}
};
...
public:
	...
	void SetSolverActive(bool bActive) // [0x307ed60] Native|Public|BlueprintCallable 
	{
	...
	void SetAsCurrentWorldSolver() // [0x307ed40] Final|Native|Public|BlueprintCallable 
	{
