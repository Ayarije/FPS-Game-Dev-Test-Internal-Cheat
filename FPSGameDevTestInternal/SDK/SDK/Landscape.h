...
public:
	...
	void SetLandscapeMaterialVectorParameterValue(FName ParameterName, FLinearColor Value) // [0x221f810] Final|RequiredAPI|Native|Public|HasDefaults|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FName, FLinearColor);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(ParameterName, Value);
	}
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialTextureParameterValue
	void SetLandscapeMaterialTextureParameterValue(FName ParameterName, UTexture* Value) // [0x221f740] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(FName, UTexture*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		func(ParameterName, Value);
	}
	// Function /Script/Landscape.LandscapeProxy.SetLandscapeMaterialScalarParameterValue
	void SetLandscapeMaterialScalarParameterValue(FName ParameterName, float Value) // [0x221f670] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
	...
	bool LandscapeExportHeightmapToRenderTarget(UTextureRenderTarget2D* InRenderTarget, bool InExportHeightIntoRGChannel, bool InExportLandscapeProxies) // [0x221f550] Final|Native|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(UTextureRenderTarget2D*, bool, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(InRenderTarget, InExportHeightIntoRGChannel, InExportLandscapeProxies);
	}
	// Function /Script/Landscape.LandscapeProxy.EditorSetLandscapeMaterial
	void EditorSetLandscapeMaterial(UMaterialInterface* NewLandscapeMaterial) // [0xa071e0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(UMaterialInterface*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		func(NewLandscapeMaterial);
	}
	// Function /Script/Landscape.LandscapeProxy.EditorApplySpline
	void EditorApplySpline(USplineComponent* InSplineComponent, float StartWidth, float EndWidth, float StartSideFalloff, float EndSideFalloff, float StartRoll, float EndRoll, int32_t NumSubdivisions, bool bRaiseHeights, bool bLowerHeights, ULandscapeLayerInfoObject* PaintLayer, FName EditLayerName) // [0x221f1c0] Final|RequiredAPI|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(USplineComponent*, float, float, float, float, float, float, int32_t, bool, bool, ULandscapeLayerInfoObject*, FName);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
		func(InSplineComponent, StartWidth, EndWidth, StartSideFalloff, EndSideFalloff, StartRoll, EndRoll, NumSubdivisions, bRaiseHeights, bLowerHeights, PaintLayer, EditLayerName);
	}
	// Function /Script/Landscape.LandscapeProxy.ChangeUseTessellationComponentScreenSizeFalloff
	void ChangeUseTessellationComponentScreenSizeFalloff(bool InComponentScreenSizeToUseSubSections) // [0x221f130] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[6]);
		func(InComponentScreenSizeToUseSubSections);
	}
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSizeFalloff
	void ChangeTessellationComponentScreenSizeFalloff(float InUseTessellationComponentScreenSizeFalloff) // [0x221f0a0] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		func(InUseTessellationComponentScreenSizeFalloff);
	}
	// Function /Script/Landscape.LandscapeProxy.ChangeTessellationComponentScreenSize
	void ChangeTessellationComponentScreenSize(float InTessellationComponentScreenSize) // [0x221f010] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[8]);
		func(InTessellationComponentScreenSize);
	}
	// Function /Script/Landscape.LandscapeProxy.ChangeLODDistanceFactor
	void ChangeLODDistanceFactor(float InLODDistanceFactor) // [0x221ef80] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
		func(InLODDistanceFactor);
	}
	// Function /Script/Landscape.LandscapeProxy.ChangeComponentScreenSizeToUseSubSections
	void ChangeComponentScreenSizeToUseSubSections(float InComponentScreenSizeToUseSubSections) // [0x221eef0] Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void RequestLandscapeUpdate() // [0xa15230] Final|Native|Public|BlueprintCallable 
	{
	...
	UTextureRenderTarget2D* Render(bool InIsHeightmap, UTextureRenderTarget2D* InCombinedResult, FName& InWeightmapLayerName) // [0x221d7d0] Native|Event|Public|HasOutParms|BlueprintEvent 
	{
		typedef class UTextureRenderTarget2D* (*FuncPtr)(bool, UTextureRenderTarget2D*, FName&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(InIsHeightmap, InCombinedResult, InWeightmapLayerName);
	}
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.Initialize
	void Initialize(FTransform& InLandscapeTransform, FIntPoint& InLandscapeSize, FIntPoint& InLandscapeRenderTargetSize) // [0x221d650] Native|Event|Public|HasOutParms|HasDefaults|BlueprintEvent 
	{
		typedef void (*FuncPtr)(FTransform&, FIntPoint&, FIntPoint&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		func(InLandscapeTransform, InLandscapeSize, InLandscapeRenderTargetSize);
	}
	// Function /Script/Landscape.LandscapeBlueprintBrushBase.GetBlueprintRenderDependencies
	// void GetBlueprintRenderDependencies(TArray<UObject*>& OutStreamableAssets);                                              // [0x12295a0] Event|Public|HasOutParms|BlueprintEvent 
};
...
public:
	...
	UMaterialInstanceDynamic* GetMaterialInstanceDynamic(int32_t InIndex) // [0x221d580] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef class UMaterialInstanceDynamic* (*FuncPtr)(int32_t);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func(InIndex);
	}
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightByNameAtLocation
	float EditorGetPaintLayerWeightByNameAtLocation(FVector& InLocation, FName InPaintLayerName) // [0x221d4a0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef float (*FuncPtr)(FVector&, FName);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(InLocation, InPaintLayerName);
	}
	// Function /Script/Landscape.LandscapeComponent.EditorGetPaintLayerWeightAtLocation
	float EditorGetPaintLayerWeightAtLocation(FVector& InLocation, ULandscapeLayerInfoObject* PaintLayer) // [0x221d3c0] Final|RequiredAPI|Native|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef float (*FuncPtr)(FVector&, ULandscapeLayerInfoObject*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(InLocation, PaintLayer);
	}
};
...
public:
	...
	ULandscapeComponent* GetRenderComponent() // [0x221d620] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef class ULandscapeComponent* (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		return func();
	}
...
public:
	...
	// TArray<USplineMeshComponent*> GetSplineMeshComponents();                                                                 // [0x2221410] Final|Native|Public|BlueprintCallable 
};
