...
{ 
	...
	SDK_UNDEFINED(16,279) /* TScriptInterface<Class> */ __um(CurveSource);                                         // 0x0030   (0x0010)  
};
...
public:
	...
	void K2_TwoBoneIK(FVector& RootPos, FVector& JointPos, FVector& EndPos, FVector& JointTarget, FVector& Effector, FVector& OutJointPos, FVector& OutEndPos, bool bAllowStretching, float StartStretchRatio, float MaxStretchScale) // [0x2324a90] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef void (*FuncPtr)(FVector&, FVector&, FVector&, FVector&, FVector&, FVector&, FVector&, bool, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(RootPos, JointPos, EndPos, JointTarget, Effector, OutJointPos, OutEndPos, bAllowStretching, StartStretchRatio, MaxStretchScale);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_StartProfilingTimer
	void K2_StartProfilingTimer() // [0x2324a70] Final|Native|Static|Public|BlueprintCallable 
	{
	...
	FVector K2_MakePerlinNoiseVectorAndRemap(float X, float Y, float Z, float RangeOutMinX, float RangeOutMaxX, float RangeOutMinY, float RangeOutMaxY, float RangeOutMinZ, float RangeOutMaxZ) // [0x2324790] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(float, float, float, float, float, float, float, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
		return func(X, Y, Z, RangeOutMinX, RangeOutMaxX, RangeOutMinY, RangeOutMaxY, RangeOutMinZ, RangeOutMaxZ);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_MakePerlinNoiseAndRemap
	float K2_MakePerlinNoiseAndRemap(float Value, float RangeOutMin, float RangeOutMax) // [0x2324670] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	{
		typedef float (*FuncPtr)(float, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
		return func(Value, RangeOutMin, RangeOutMax);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_LookAt
	FTransform K2_LookAt(FTransform& CurrentTransform, FVector& TargetPosition, FVector LookAtVector, bool bUseUpVector, FVector UpVector, float ClampConeInDegree) // [0x23243d0] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FTransform (*FuncPtr)(FTransform&, FVector&, FVector, bool, FVector, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		return func(CurrentTransform, TargetPosition, LookAtVector, bUseUpVector, UpVector, ClampConeInDegree);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_EndProfilingTimer
	float K2_EndProfilingTimer(bool bLog, FString LogPrefix) // [0x23242e0] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef float (*FuncPtr)(bool, FString);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[5]);
		return func(bLog, LogPrefix);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DistanceBetweenTwoSocketsAndMapRange
	// float K2_DistanceBetweenTwoSocketsAndMapRange(USkeletalMeshComponent* Component, FName SocketOrBoneNameA, TEnumAsByte<ERelativeTransformSpace> SocketSpaceA, FName SocketOrBoneNameB, TEnumAsByte<ERelativeTransformSpace> SocketSpaceB, bool bRemapRange, float InRangeMin, float InRangeMax, float OutRangeMin, float OutRangeMax); // [0x2323ff0] Final|Native|Static|Public|BlueprintCallable|BlueprintPure 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_DirectionBetweenSockets
	FVector K2_DirectionBetweenSockets(USkeletalMeshComponent* Component, FName SocketOrBoneNameFrom, FName SocketOrBoneNameTo) // [0x2323ee0] Final|Native|Static|Public|HasDefaults|BlueprintCallable|BlueprintPure 
	{
		typedef FVector (*FuncPtr)(USkeletalMeshComponent*, FName, FName);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[7]);
		return func(Component, SocketOrBoneNameFrom, SocketOrBoneNameTo);
	}
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromSockets
	// float K2_CalculateVelocityFromSockets(float DeltaSeconds, USkeletalMeshComponent* Component, FName SocketOrBoneName, FName ReferenceSocketOrBone, TEnumAsByte<ERelativeTransformSpace> SocketSpace, FVector OffsetInBoneSpace, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax, EEasingFuncType EasingType, FRuntimeFloatCurve& CustomCurve); // [0x2323a80] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	// Function /Script/AnimGraphRuntime.KismetAnimationLibrary.K2_CalculateVelocityFromPositionHistory
	float K2_CalculateVelocityFromPositionHistory(float DeltaSeconds, FVector Position, FPositionHistory& History, int32_t NumberOfSamples, float VelocityMin, float VelocityMax) // [0x2323860] Final|Native|Static|Public|HasOutParms|HasDefaults|BlueprintCallable 
	{
		typedef float (*FuncPtr)(float, FVector, FPositionHistory&, int32_t, float, float);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[9]);
		return func(DeltaSeconds, Position, History, NumberOfSamples, VelocityMin, VelocityMax);
	}
};
...
{ 
public:
	SDK_UNDEFINED(16,280) /* FMulticastInlineDelegate */ __um(OnCompleted);                                        // 0x0028   (0x0010)  
	SDK_UNDEFINED(16,281) /* FMulticastInlineDelegate */ __um(OnBlendOut);                                         // 0x0038   (0x0010)  
	SDK_UNDEFINED(16,282) /* FMulticastInlineDelegate */ __um(OnInterrupted);                                      // 0x0048   (0x0010)  
	SDK_UNDEFINED(16,283) /* FMulticastInlineDelegate */ __um(OnNotifyBegin);                                      // 0x0058   (0x0010)  
	SDK_UNDEFINED(16,284) /* FMulticastInlineDelegate */ __um(OnNotifyEnd);                                        // 0x0068   (0x0010)  
	...
	void OnNotifyEndReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload) // [0x2325e10] Final|Native|Protected|HasOutParms 
	{
		typedef void (*FuncPtr)(FName, FBranchingPointNotifyPayload&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
		func(NotifyName, BranchingPointNotifyPayload);
	}
	// Function /Script/AnimGraphRuntime.PlayMontageCallbackProxy.OnNotifyBeginReceived
	void OnNotifyBeginReceived(FName NotifyName, FBranchingPointNotifyPayload& BranchingPointNotifyPayload) // [0x2325d20] Final|Native|Protected|HasOutParms 
	{
		typedef void (*FuncPtr)(FName, FBranchingPointNotifyPayload&);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void OnMontageEnded(UAnimMontage* Montage, bool bInterrupted) // [0x2325c50] Final|Native|Protected 
	{
	...
	void OnMontageBlendingOut(UAnimMontage* Montage, bool bInterrupted) // [0x2325b80] Final|Native|Protected 
	{
		typedef void (*FuncPtr)(UAnimMontage*, bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[3]);
	...
	UPlayMontageCallbackProxy* CreateProxyObjectForPlayMontage(USkeletalMeshComponent* InSkeletalMeshComponent, UAnimMontage* MontageToPlay, float PlayRate, float StartingPosition, FName StartingSection) // [0x23259f0] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UPlayMontageCallbackProxy* (*FuncPtr)(USkeletalMeshComponent*, UAnimMontage*, float, float, FName);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
		return func(InSkeletalMeshComponent, MontageToPlay, PlayRate, StartingPosition, StartingSection);
	}
};
