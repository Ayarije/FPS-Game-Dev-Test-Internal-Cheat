...
public:
	...
	SDK_UNDEFINED(16,636) /* FMulticastInlineDelegate */ __um(OnNewLocalDataFromClients);                          // 0x0318   (0x0010)  
	...
	bool SendSharedWorldDataToClients() // [0xd46980] Final|BlueprintAuthorityOnly|Native|Public|BlueprintCallable 
	{
	...
	void SelectChosenOne() // [0xd46960] BlueprintAuthorityOnly|Native|Event|Public|BlueprintCallable|BlueprintEvent 
	{
	...
	void MagicLeapOnNewLocalDataFromClients__DelegateSignature() // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void DetermineSharedWorldData(FMagicLeapSharedWorldSharedData& NewSharedWorldData) // [0xd46840] BlueprintAuthorityOnly|Native|Event|Public|HasOutParms|BlueprintCallable|BlueprintEvent 
	{
...
public:
	...
	SDK_UNDEFINED(16,637) /* FMulticastInlineDelegate */ __um(OnSharedWorldDataUpdated);                           // 0x02B0   (0x0010)  
	SDK_UNDEFINED(16,638) /* FMulticastInlineDelegate */ __um(OnAlignmentTransformsUpdated);                       // 0x02C0   (0x0010)  


	/// Functions
	// Function /Script/MagicLeapSharedWorld.MagicLeapSharedWorldGameState.OnReplicate_SharedWorldData
	void OnReplicate_SharedWorldData() // [0xd46940] Final|Native|Private 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void OnReplicate_AlignmentTransforms() // [0xd46920] Final|Native|Private 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
	...
	void MagicLeapSharedWorldEvent__DelegateSignature() // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	FTransform CalculateXRCameraRootTransform() // [0xd466f0] Native|Event|Public|HasDefaults|BlueprintCallable|BlueprintEvent|BlueprintPure|Const 
	{
...
public:
	...
	void ServerSetLocalWorldData(FMagicLeapSharedWorldLocalData LocalWorldReplicationData) // [0xd46a50] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	{
	...
	void ServerSetAlignmentTransforms(FMagicLeapSharedWorldAlignmentTransforms InAlignmentTransforms) // [0xd469b0] Net|NetReliableNative|Event|Public|NetServer|BlueprintCallable 
	{
	...
	bool IsChosenOne() // [0xd468f0] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[2]);
	...
	void ClientSetChosenOne(bool bChosenOne) // [0xd467b0] Net|NetReliableNative|Event|Public|NetClient|BlueprintCallable 
	{
	...
	void ClientMarkReadyForSendingLocalData() // [0xd46790] Net|NetReliableNative|Event|Public|NetClient 
	{
		typedef void (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	bool CanSendLocalDataToServer() // [0xd46760] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
		typedef bool (*FuncPtr)();
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
