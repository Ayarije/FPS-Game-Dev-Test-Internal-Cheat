...
{ 
public:
	SDK_UNDEFINED(80,342) /* TSet<FName> */            __um(Layers);                                               // 0x0030   (0x0050)  
	SDK_UNDEFINED(80,343) /* TSet<FName> */            __um(Tags);                                                 // 0x0080   (0x0050)  
};
...
public:
	...
	FString GetDatasmithUserDataValueForKey(UObject* Object, FName Key) // [0xa070d0] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef FString (*FuncPtr)(UObject*, FName);
	...
	// void GetDatasmithUserDataKeysAndValuesForValue(UObject* Object, FString StringToMatch, TArray<FName>& OutKeys, TArray<FString>& OutValues); // [0xa06f10] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/DatasmithContent.DatasmithContentBlueprintLibrary.GetDatasmithUserData
	UDatasmithAssetUserData* GetDatasmithUserData(UObject* Object) // [0xa06e80] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef class UDatasmithAssetUserData* (*FuncPtr)(UObject*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	void PlayLevelSequence(ULevelSequence* SequenceToPlay) // [0xa071e0] Final|Native|Public|BlueprintCallable 
	{
...
public:
	...
	SDK_UNDEFINED(80,344) /* TMap<FName, TWeakObjectPtr<UTexture*>> */ __um(TextureParameterValues);               // 0x00F8   (0x0050)  
...
public:
	...
	SDK_UNDEFINED(80,345) /* TMap<FName, TWeakObjectPtr<AActor*>> */ __um(RelatedActors);                          // 0x0228   (0x0050)  
};
...
public:
	...
	SDK_UNDEFINED(80,346) /* TSet<FName> */            __um(Tags);                                                 // 0x0098   (0x0050)  
