...
public:
	...
	// bool RequestPrivilegeAsync(EMagicLeapPrivilege Privilege, FDelegateProperty& ResultDelegate);                            // [0xd73ab0] Final|Native|Static|Public|HasOutParms|BlueprintCallable 
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.RequestPrivilege
	bool RequestPrivilege(EMagicLeapPrivilege Privilege) // [0xd73a30] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(EMagicLeapPrivilege);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[1]);
		return func(Privilege);
	}
	// Function /Script/MagicLeapPrivileges.MagicLeapPrivilegesFunctionLibrary.CheckPrivilege
	bool CheckPrivilege(EMagicLeapPrivilege Privilege) // [0xd73a30] Final|Native|Static|Public|BlueprintCallable 
	{
		typedef bool (*FuncPtr)(EMagicLeapPrivilege);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
