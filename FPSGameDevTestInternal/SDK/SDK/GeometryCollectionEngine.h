...
public:
	...
	SDK_UNDEFINED(80,348) /* TSet<AChaosSolverActor*> */ __um(ChaosSolverActors);                                  // 0x0248   (0x0050)  
	SDK_UNDEFINED(80,349) /* TSet<AGeometryCollectionActor*> */ __um(GeometryCollectionActors);                    // 0x0298   (0x0050)  
	SDK_UNDEFINED(16,350) /* FMulticastInlineDelegate */ __um(OnCollisionEvents);                                  // 0x02E8   (0x0010)  
	SDK_UNDEFINED(16,351) /* FMulticastInlineDelegate */ __um(OnBreakingEvents);                                   // 0x02F8   (0x0010)  
	SDK_UNDEFINED(16,352) /* FMulticastInlineDelegate */ __um(OnTrailingEvents);                                   // 0x0308   (0x0010)  
	...
	// void SortTrailingEvents(TArray<FChaosTrailingEventData>& TrailingEvents, EChaosTrailingSortMethod SortMethod);           // [0x30a4a20] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortCollisionEvents
	// void SortCollisionEvents(TArray<FChaosCollisionEventData>& CollisionEvents, EChaosCollisionSortMethod SortMethod);       // [0x30a4920] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SortBreakingEvents
	// void SortBreakingEvents(TArray<FChaosBreakingEventData>& BreakingEvents, EChaosBreakingSortMethod SortMethod);           // [0x30a4820] Final|Native|Public|HasOutParms|BlueprintCallable 
	// Function /Script/GeometryCollectionEngine.ChaosDestructionListener.SetTrailingEventRequestSettings
	void SetTrailingEventRequestSettings(FChaosTrailingEventRequestSettings& InSettings) // [0x30a4780] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetTrailingEventEnabled(bool BIsEnabled) // [0x30a46f0] Final|Native|Public|BlueprintCallable 
	{
	...
	void SetCollisionEventRequestSettings(FChaosCollisionEventRequestSettings& InSettings) // [0x30a45c0] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetCollisionEventEnabled(bool BIsEnabled) // [0x30a4530] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void SetBreakingEventRequestSettings(FChaosBreakingEventRequestSettings& InSettings) // [0x30a4490] Final|Native|Public|HasOutParms|BlueprintCallable 
	{
	...
	void SetBreakingEventEnabled(bool BIsEnabled) // [0x30a4400] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void RemoveGeometryCollectionActor(AGeometryCollectionActor* GeometryCollectionActor) // [0x30a4370] Final|Native|Public|BlueprintCallable 
	{
	...
	void RemoveChaosSolverActor(AChaosSolverActor* ChaosSolverActor) // [0xa071e0] Final|Native|Public|BlueprintCallable 
	{
	...
	bool IsEventListening() // [0x30a4090] Final|Native|Public|BlueprintCallable|BlueprintPure|Const 
	{
	...
	void AddGeometryCollectionActor(AGeometryCollectionActor* GeometryCollectionActor) // [0x30a3da0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(AGeometryCollectionActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
	...
	void AddChaosSolverActor(AChaosSolverActor* ChaosSolverActor) // [0xa071e0] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(AChaosSolverActor*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
...
public:
	...
	bool RaycastSingle(FVector Start, FVector End, FHitResult& OutHit) // [0x30a4200] Final|Native|Public|HasOutParms|HasDefaults|BlueprintCallable|BlueprintPure|Const 
	{
...
public:
	...
	SDK_UNDEFINED(16,353) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsStateChange);         // 0x0640   (0x0010)  
	SDK_UNDEFINED(16,354) /* FMulticastInlineDelegate */ __um(NotifyGeometryCollectionPhysicsLoadingStateChange);  // 0x0650   (0x0010)  
	unsigned char                                      UnknownData09_6[0x18];                                      // 0x0660   (0x0018)  MISSED
	SDK_UNDEFINED(16,355) /* FMulticastInlineDelegate */ __um(OnChaosBreakEvent);                                  // 0x0678   (0x0010)  
	...
	SDK_UNDEFINED(16,356) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0690   (0x0010)  
	...
	void SetNotifyBreaks(bool bNewNotifyBreaks) // [0x30a4660] Final|Native|Public|BlueprintCallable 
	{
		typedef void (*FuncPtr)(bool);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[0]);
	...
	void ReceivePhysicsCollision(FChaosPhysicsCollisionInfo& CollisionInfo) // [0x12295a0] Event|Public|HasOutParms|BlueprintEvent 
	{
	...
	void OnRep_RepData(FGeometryCollectionRepData& OldData) // [0x30a4150] Final|Native|Protected|HasOutParms 
	{
	...
	void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(UGeometryCollectionComponent* FracturedComponent) // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
	...
	void NotifyGeometryCollectionPhysicsLoadingStateChange__DelegateSignature(UGeometryCollectionComponent* FracturedComponent) // [0x12295a0] MulticastDelegate|Public|Delegate 
	{
		typedef void (*FuncPtr)(UGeometryCollectionComponent*);
		auto vtablePtr = reinterpret_cast<uintptr_t*>(vtable);
		auto func = reinterpret_cast<FuncPtr>(vtablePtr[4]);
	...
	void NetAbandonCluster(int32_t TransformIndex) // [0x30a40c0] Final|Net|NetReliableNative|Event|NetMulticast|Private 
	{
	...
	void ApplyPhysicsField(bool Enabled, EGeometryCollectionPhysicsTypeEnum Target, UFieldSystemMetaData* MetaData, UFieldNodeBase* Field) // [0x30a3f10] Final|Native|Public|BlueprintCallable 
	{
	...
	void ApplyKinematicField(float Radius, FVector Position) // [0x30a3e30] Final|Native|Public|HasDefaults|BlueprintCallable 
	{
...
public:
	...
	SDK_UNDEFINED(16,357) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0118   (0x0010)  
...
public:
	...
	SDK_UNDEFINED(16,358) /* FMulticastInlineDelegate */ __um(OnChaosPhysicsCollision);                            // 0x0100   (0x0010)  
	...
	void ForceRecreatePhysicsState() // [0x30a4070] Final|Native|Public|BlueprintCallable 
	{
